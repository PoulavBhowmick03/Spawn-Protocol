    ...
    <DashboardPageFrame>
      ...
      <div className="p-4 space-y-4">
        <DashboardPanel>
          ...
          {tab === "governance" && (
            <div className="border-b border-white/[0.08] px-4 py-2 font-mono text-[10px] text-[#4a4f5e] uppercase tracking-widest">
              SOURCE_DAO = EXTERNAL DAO OR MARKET · SIM_GOV = INTERNAL SPAWN SIMULATION GOVERNOR
            </div>
          )}
